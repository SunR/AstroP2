...
trainingSetEllipticals = ellipticals[:500] #check whether these numbers are inclusive
trainingSetSpirals = spirals[:500] #extracting first 5000 spiral and elliptical to train model, excluding last 3 cols (labels)
...
#Testing accuracy
testingSetEllipticals = ellipticals[500:1000]
testingSetSpirals = spirals[500:1000]
...
f = open('uncertainsPredictionsOutput2.txt', 'w')
